...
| global | description |
|--------|-------------|
| `indi` | INDI device API — `connect_device()`, `set_number()`, `set_switch()`, `wait_for_state()`, etc. |
